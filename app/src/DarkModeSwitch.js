...
function DarkModeSwitch(props) {
  ...
  return (
    <div className={"flex flex-col justify-center " + props.className}>
      <label className="relative cursor-pointer p-2 group" htmlFor="light-switch">
        ...
        <div role="tooltip" className="absolute right-0 top-10 z-10 hidden md:inline-block w-36 px-2 py-1 text-sm font-medium text-slate-700 dark:text-slate-300 text-center transition-opacity duration-300 rounded-lg shadow-sm opacity-0 group-hover:opacity-100 tooltip bg-slate-300 dark:bg-slate-700">
