    ...
    <div className="p-6 mx-2 bg-gray-200 dark:bg-slate-950 border border-gray-200 dark:border-gray-900 rounded-lg shadow">
      ...
      <div className="chips mt-2">
        {props.chips && props.chips.map((chip, i) => {
          return <div key={i} className="inline-block relative px-2 py-1 mr-2 font-sans text-xs font-bold text-gray-200 dark:text-white uppercase bg-gray-500 dark:bg-gray-900 rounded-md select-none whitespace-nowrap">
